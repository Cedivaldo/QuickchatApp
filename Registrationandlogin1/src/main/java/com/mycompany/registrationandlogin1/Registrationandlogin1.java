...
public class Registrationandlogin1 {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            Registration registration = new Registration(username, password, firstName, lastName, cellPhoneNumber);

            String registrationResult = registration.registerUser();
            System.out.println("\n" + registrationResult);

            if (!registrationResult.startsWith("Username successfully captured")) {
            ...
            Login login = new Login(enteredUsername, enteredPassword, registration);
